...
const InputField = ({ label, type = "text", name, value, onChange }: InputFieldProps) => {
    return (
        ...
        <input
            ...
            onChange={onChange}
            required
            className="input input-bordered w-full bg-transparent text-gray-800 peer input-info
            peer-autofill:bg-white peer-autofill:text-gray-800 autofill:bg-white autofill:text-gray-800"
        />
        <label
